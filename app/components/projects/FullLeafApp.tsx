...
const FullLeafApp: React.FC = () => {
  ...
  const neonBanner = (
    <div className="flex justify-center my-4">
      <div
        className="inline-block px-4 py-2 rounded-lg border-4 border-pink-400"
        style={{
      ...
      >
        <p
          className="text-lg sm:text-xl font-bold uppercase tracking-wider text-pink-400 flex flex-wrap justify-center items-center"
          style={{
            fontFamily:
